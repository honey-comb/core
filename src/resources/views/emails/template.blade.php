                    ...
                    <td style="{{ $style['email-body'] }}" width="100%">
                        <table style="{{ $style['email-body_inner'] }}" align="center" width="570" cellpadding="0"
                            ...
                            <tr>
                                    ...
                                    <h1 style="{{ $style['header-1'] }}">
                                        ...
                                        @else
                                            @if ($level == 'error')
                                                Whoops!
                                            @else
                                                {{ trans('HCCore::mail.password.hello') }}
                                            @endif
                                        @endif
                                    </h1>
                                ...
                                <!-- Salutation -->
                                    <p style="{{ $style['paragraph'] }}">
                                        {{ trans('HCCore::mail.password.regards')}}<br>{{ config('app.name') }}
                                    </p>
                                            ...
                                            <tr>
                                                <td style="{{ $fontFamily }}">
                                                    <p style="{{ $style['paragraph-sub'] }}">
                                                        {{ trans('HCCore::mail.password.body_sub', ['actionText' => $actionText]) }}
                                                    </p>
                            ...
                            <tr>
                                <td style="{{ $fontFamily }} {{ $style['email-footer_cell'] }}">
                                    <p style="{{ $style['paragraph-sub'] }}">
                                        ...
                                        {{ trans('HCCore::mail.password.copyright') }}
                                    </p>
                                </td>
                            </tr>
                        </table>
